...
if (socket.gethostname() == 'jose-Cyborg-15-A13VE'):
    config['datadir'] = '/home/jose/miniconda3/envs/supereeg_pipeline_test/startdir/datadir'
    config['workingdir'] = '/home/jose/miniconda3/envs/supereeg_pipeline_test/startdir/workingdir/bo'

...
if (socket.gethostname() == 'jose-Cyborg-15-A13VE'):
    config['datadir'] = '/home/jose/miniconda3/envs/supereeg_pipeline_test/startdir/workingdir/full_mats/results'
    config['workingdir'] = '/home/jose/miniconda3/envs/supereeg_pipeline_test/startdir/workingdir/ave_mats'

...
if (socket.gethostname() == 'jose-Cyborg-15-A13VE'):
    ...
    config['workingdir'] = '/home/jose/miniconda3/envs/supereeg_pipeline_test/supereeg_hellgate/startdir/workingdir/recon'
...
config['avedir'] = os.path.join(config['startdir'], 'workingdir/ave_mats/results')

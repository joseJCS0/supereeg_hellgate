...
#(results_dir, 'ave_mat_' + freq)(OG)
if os.path.exists(os.path.join(results_dir, 'ave_mat')):
...
try:
   ...
   print(err)
#mos = glob.glob(os.path.join(model_dir, '*' + freq + '.mo'))(OG)
...
#mo.save(os.path.join(results_dir, 'ave_mat_' + freq))(OG)
